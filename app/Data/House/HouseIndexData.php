...
class HouseIndexData extends Data
{
    /** @var int */
    public int $id;
    ...
    public static function fromModel(House $house): self
    {
        return self::from([
            ...
            'services' => $house->relationLoaded(key: 'dictConnectedServices')
                ...
                : null,
            'rooms' => $house->relationLoaded(key: 'rooms')
                ? RoomIndexData::collect($house->rooms)
                : null,
        ]);
    }
}
